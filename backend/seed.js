...
.then(async () => {
    ...
    if (!productExists) {
        const product = new Product({
            ...
            category: 'Watches',
            images: [{ url: 'https://images.unsplash.com/photo-1524592094714-0f0654e20314?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80' }]
        });
        await product.save();
    ...
    if(!product2Exists) {
        const product2 = new Product({
            ...
            category: 'Audio',
            images: [{ url: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80' }]
        });
        await product2.save();
